...
Using `save()` we will save the merged dataset to be used in the next vignette on how to visualize wastewater data. We will save the dataset in both CSV and RData formats.
